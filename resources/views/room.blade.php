...
<script>
    ...
    function participantConnected(participant) {
        ...
        div.innerHTML = "<div class='video-box-title'>" +participant.identity +"</div>";
        ...
        document.getElementById('media-div').append(div);
    }
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="title video-title">
                <h3> <span class="fa fa-video-camera"></span>    Video Chat Rooms</h3>
            </div>
            <div id="media-div">
             </div>
       </div>
